...
* #1.5    "記録署名"
  ...
  * #1.5.1  "記録登録タイムスタンプ管理" "説明）全ての記録はその情報がシステムに登録されたタイムスタンプによる時系列管理ができるようにする。"
* #1.6    "支援"
  * #1.6.1   "診療記録入力支援"
    * #1.6.1.1 "入力方式選択"
      * #1.6.1.1.1  "テンプレート入力"
  ...
  * #1.6.3  "診療支援"
    * #1.6.3.2  "クリニカルパス"
    * #1.6.3.3  "療養計画書等の文書の自動作成"
    * #1.6.3.4  "Planからのスケジューリングオーダの自動作成" "例）計画書から定期オーダセット(来院毎、半年毎の検査、1年毎の紹介、等)の自動作成"
    * #1.6.3.5  "診療参考情報の表示"
      * #1.6.3.5.1 "臨床ガイドライン・参考となる診療指針の表示"
        * #1.6.3.5.1.1 "対象疾患・プロブレムベースで自動選択して表示"
        * #1.6.3.5.1.2 "患者の診療コンテキスト（病状）に合わせて自動選択して表示"
    * #1.6.3.6  "ガイドラインベースの動的ナビゲーション"
    * #1.6.3.7  "施設横断データにもとづく診療参考情報の表示"
  * #1.6.4  "医療安全支援"
    * #1.6.4.1  "アラート・リマインド"
      * #1.6.4.1.T1  ":処方作成"
...
* #1.7    "診療記録管理"
  ...
  * #1.8.2  "オーダと記録の履歴管理"
  * #1.8.3  "要約の作成"
    * #1.8.3.1 "前回受診までの「診療ダイジェスト」作成"  "メモ）サマリー、レジュメ、ダイジェストの違いなどを定義。"
    * #1.8.3.1 "診療の質の評価指標の可視化"
* #1.8    "患者基本情報の登録・管理"
  * #1.8.1  "患者個人識別情報の登録・管理"
  * #1.8.2  "保険情報の登録・管理"
* #1.9 "患者環境の登録・管理"
  * #1.10.1 "関連者情報（支援者・介護者・キーパーソンなど）"
  * #1.10.2 "家族構成"
  * #1.10.3 "介護等の患者支援サービスの利用状況"
* #1.10   "受診情報管理"
  * #1.10.1 "外来受診歴情報"
  * #1.10.2 "入退院履歴情報"
