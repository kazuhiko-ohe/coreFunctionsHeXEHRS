...
Title: "HeXEHRS System Core Functions Code System for Clinical Record　診療記録・管理"
Description: "HeXEHRS Core Functions の　診療記録・管理　ID体系"
...
* #R1.3    "診療記録閲覧"
  * #R1.3.1 "記録の履歴表示と記録選択"
    ...
    * #R1.3.1.3  "医療行為歴ベースの履歴表示と記録選択"  "処方歴、検査歴、その他の医療提供行為の表示とそこからの選択"
      * #R1.3.1.3.1 "オーダ歴"
        * #R1.3.1.3.1.1 "オーダ種別選択"
          * #R1.3.1.3.1.1.T1 ":処方" "See. S1.1"
          * #R1.3.1.3.1.1.T2 ":注射" "See. S2.1"
          * #R1.3.1.3.1.1.T3 ":検体検査" "See. S3.1"
          * #R1.3.1.3.1.1.T4 ":細菌検査" "See. S4.1"
          * #R1.3.1.3.1.1.T5 ":病理検査" "See. S5.1"
          * #R1.3.1.3.1.1.T6 ":診療予約" "See. S6.1"
      * #R1.3.1.3.2 "オーダ実施記録歴"
  ...
  * #R1.3.7 "他施設の診療記録の表示" "他の機関で記録された診療記録を自機関から参照"
...
* #R1.4    "診療記録入力・修正"
  ...
  * #R1.4.2  "オーダ作成・登録"
    * #R1.4.2.T1 ":処方" "See. S1.1"
    * #R1.4.2.T2 ":注射" "See. S2.1"
    * #R1.4.2.T3 ":検体検査" "See. S3.1"
    * #R1.4.2.T4 ":細菌検査" "See. S4.1"
    * #R1.4.2.T5 ":病理検査" "See. S5.1"
    * #R1.4.2.T6 ":診療予約" "See. S6.1"
      * #R1.4.2.T6.1 ":外来診療予約"
      * #R1.4.2.T6.2 ":オンライン診察予約"
  * #R1.4.3  "実施後入力"
...
* #R1.12   "施設間・患者連携"
  ...
  * #R1.12.4.2 "患者による共同診療の支援"
    * #R1.12.4.2.1 "患者によるカルテの閲覧・追記"
    * #R1.3.7.1.T1 ":連携するPHRリソースの表示"
      * ^property[+].code = #elementClass
      * ^property[=].valueString = "PHR"
    * #R1.12.4.2.2 "患者による「オンライン診療」のオンライン予約"
